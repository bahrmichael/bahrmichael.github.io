...
For [pinning the versions of GitHub Actions workflows](https://docs.renovatebot.com/presets-helpers/#helperspingithubactiondigests) we need to tell Renovate to do the same by adding a preset.
